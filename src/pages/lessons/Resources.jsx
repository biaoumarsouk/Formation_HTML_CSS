...
const playlists = [
  {
    ...
    videos: [
      { title: "Cours complet sur le développement Web", channel: "Malakisi", duration: "5h22", url: "https://youtu.be/nf2XHSpI4WA?si=ND_JNPRleKo4kVl0" },
      { title: "HTML Crash Course For Beginners", channel: "Traversy Media", duration: "1h", url: "https://www.youtube.com/watch?v=UB1O30fR-EE" },
      { title: "Apprendre CSS de zéro", channel: "From Scratch", duration: "2h20 min", url: "https://youtu.be/iSWjmVcfQGg?si=y9y_NuQkyUHAJmoB" },
      { title: "Apprendre le HTML", channel: "MaxCode", duration: "2h", url: "https://youtu.be/rRt-yvGQST0?si=CmWHI2i8XAanq9KN" },
    ],
  },
  {
    ...
    color: "bg-blue-600",
    videos: [
      { title: "Tuto Flexbox", channel: "Front-end", duration: "12 min", url: "https://youtu.be/DPHgIIdrmFk?si=GUxvoR8U7Dh5I3Aj" },
      ...
      { title: "Apprendre CSS GRID", channel: "Front-end", duration: "18 min", url: "https://youtu.be/Jarz_GZG7-I?si=rm2Z2LC4jlXKal09" },
  ...
  },
  {
    ...
    color: "bg-violet-600",
    videos: [
      { title: "Les Bases du Responsive", channel: "Cedric Design", duration: "14 min", url: "https://youtu.be/BdzKNrxLiSs?si=v7wv1JL1KeuNnZy3" },
      { title: "Créer un site internet adapté à tous les écrans", channel: "Louis-Nicolas", duration: "34 min", url: "https://youtu.be/vafKksOf_q8?si=iQ-ZB9P6x8rHTfXm" },
